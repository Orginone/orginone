...
const (
	// Label holds the string label denoting the asmarketappgroupdistribution type in the database.
	Label = "as_market_app_group_distribution"
	...
	EdgeGroupx = "groupx"
	// Table holds the table name of the asmarketappgroupdistribution in the database.
	Table = "as_market_app_group_distribution"
	// AppxTable is the table that holds the appx relation/edge.
	AppxTable = "as_market_app_group_distribution"
	...
	GroupxTable = "as_market_app_group_distribution"
...
// Columns holds all SQL columns for asmarketappgroupdistribution fields.
var Columns = []string{
	FieldID,
	FieldRemark,
	FieldAppID,

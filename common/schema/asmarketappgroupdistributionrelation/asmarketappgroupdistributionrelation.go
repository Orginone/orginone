...
const (
	// Label holds the string label denoting the asmarketappgroupdistributionrelation type in the database.
	Label = "as_market_app_group_distribution_relation"
	...
	EdgeGroupx = "groupx"
	// Table holds the table name of the asmarketappgroupdistributionrelation in the database.
	Table = "as_market_app_group_distribution_relation"
	// AppxTable is the table that holds the appx relation/edge.
	AppxTable = "as_market_app_group_distribution_relation"
	...
	GroupxTable = "as_market_app_group_distribution_relation"
...
// Columns holds all SQL columns for asmarketappgroupdistributionrelation fields.
var Columns = []string{
	FieldID,
	FieldAppID,
	FieldRelationID,

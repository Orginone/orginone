...
const (
	// Label holds the string label denoting the asworkingdata type in the database.
	Label = "as_working_data"
	...
	EdgeUser = "user"
	// Table holds the table name of the asworkingdata in the database.
	Table = "as_working_data"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "as_working_data"
	// UserInverseTable is the table name for the AsUser entity.
	// It exists in this package in order to avoid circular dependency with the "asuser" package.
	UserInverseTable = "as_user"
	// UserColumn is the table column denoting the user relation/edge.
	UserColumn = "user_id"
)

// Columns holds all SQL columns for asworkingdata fields.
var Columns = []string{
	FieldID,
	FieldAppID,
	FieldUserID,

...
const (
	// Label holds the string label denoting the aslayer type in the database.
	Label = "as_layer"
	...
	EdgeGroup = "group"
	// Table holds the table name of the aslayer in the database.
	Table = "as_layer"
...
// Columns holds all SQL columns for aslayer fields.
var Columns = []string{
	FieldID,
	FieldLayer,
	FieldWidth,

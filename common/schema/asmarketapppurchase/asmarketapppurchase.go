...
const (
	// Label holds the string label denoting the asmarketapppurchase type in the database.
	Label = "as_market_app_purchase"
	...
	EdgeGroupx = "groupx"
	// Table holds the table name of the asmarketapppurchase in the database.
	Table = "as_market_app_purchase"
	// AppxTable is the table that holds the appx relation/edge.
	AppxTable = "as_market_app_purchase"
	...
	GroupxTable = "as_market_app_purchase"
...
// Columns holds all SQL columns for asmarketapppurchase fields.
var Columns = []string{
	FieldID,
	FieldAppID,
	FieldTenantID,
